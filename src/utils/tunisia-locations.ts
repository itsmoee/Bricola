export const tunisianCities: Record<string, string[]> = {
  Tataouine: ['Tataouine City', 'Ghomrassen', 'Bir Lahmar', 'Dehiba', 'Remada', 'Smar'],
  Tunis: ['Tunis Centre', 'La Marsa', 'Sidi Bou Said', 'Carthage', 'Goulette', 'Lac 1 & 2', 'Bardo', 'Menzah', 'Ennasr'],
  Ariana: ['Ariana City', 'Raoued', 'Soukra', 'Mnihla', 'Kalaat el-Andalous'],
  'Ben Arous': ['Ben Arous', 'Ezzahra', 'Hammam Lif', 'Bou Mhel', 'Megrine', 'Rades', 'Mornag'],
  ...
  Monastir: ['Monastir City', 'Sahline', 'Teboulba', 'Sayada', 'Ksar Hellal', 'Moknine'],
  ...
  Beja: ['Beja City', 'Medjez el Bab', 'Testour', 'Teboursouk'],
  Jendouba: ['Jendouba City', 'Tabarka', 'Ain Draham', 'Bou Salem'],
  Kef: ['Kef City', 'Dahmani', 'Sers', 'Tajerouine'],
  Siliana: ['Siliana City', 'Makthar', 'Bou Arada', 'Gaafour'],
  Kairouan: ['Kairouan City', 'Bou Hajla', 'Haffouz', 'Nasrallah'],
  Kasserine: ['Kasserine City', 'Sbeitla', 'Thala', 'Feriana'],
